...
<head>
    ...
    <title>Plan du site | EBconnections</title>
   ...
   <div class="header">
       <div class="container">
          <div class="navbar">
              ...
              <a href="cart.php"><img src="Public/images/cart.png" width="30px" height="30px"></a>
            ...
            <div class="footer-col3">
               <h3>Liens Utiles</h3>
                <ul>
                    ...
                    <li><a href="cookies.php">Politique des cookies</a></li>
