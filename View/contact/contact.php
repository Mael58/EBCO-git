...
<main>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $corpsEmail= "Demande: \n";
    $corpsEmail .= "Produit ou service: $produit\n";
    $corpsEmail .= "Type de câble: $typeCable\n";
    $corpsEmail .= "Connecteur: $connecteur\n";
    $corpsEmail .="Longueur du câble: $longueur \n";
    $corpsEmail .= "quantité : $qty\n";

    $corpsEmail .= "Contact :\n";
    $corpsEmail .= "Nom : $nom\n";
    $corpsEmail .= "Prenom : $prenom\n";
    $corpsEmail .= "E-mail : $email\n";
    $corpsEmail .= "Numéro de téléphone : $telephone\n\n";

    $corpsEmail .= "Société :\n";
    $corpsEmail .= "Nom de la société : $societe\n";
    $corpsEmail .= "Adresse : $adresse\n";
    $corpsEmail .= "Code postal : $codepostal\n";
    $corpsEmail .= "Ville : $ville\n";
    $corpsEmail .= "Numéro de téléphone de la société : $stel\n";
    $corpsEmail .= "Email de la société : $semail\n";
    $corpsEmail .= "Pays : $spays\n\n";
