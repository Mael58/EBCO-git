...
<head>
    ...
    <title>Fiche produit | EBconnections</title>
...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
            <img src="images/R485-400px.png" width="100%" id="ProductImg">
            <div class="small-img-row">
               <div class="small-img-col">
                   <img src="images/R485-400px.png" class="small-img" width="100%">
               </div>
               <div class="small-img-col">
                   <img src="images/R485-400px.png" class="small-img" width="100%">
               </div>
        ...
        <div class="col-2">
            <p>Accueil / Câble USB R485</p>
            <h1>Câble USB R485</h1>
            <h4>20,50€</h4>
            ...
            <h3>Spécifications techniques<i class="fa fa-indent"></i></h3>
            <br>
            
            <p>Signal : RS 485</p>
            <p>Débit : 3MBaud</p>
            <p>Débit USB 2.0 : 12Mb/s</p>
            <p>Connecteur USB : Type A </p>
            <p>Connexion max possible : 1200m (3900ft)</p>
            <p>Puissance max de sortie : +5V / 250mA</p>
            <p>Résistance thermique : de -40°C à +85°C</p>
